      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="relative flex-1">
            <div className="w-full h-[46px] rounded-xl bg-muted/60 dark:bg-muted-dark/60 dark:bg-muted dark:bg-muted-dark/60"></div>
          </div>
          <div className="flex gap-2">
            <div className="w-[140px] h-[46px] rounded-xl bg-muted/60 dark:bg-muted-dark/60 dark:bg-muted dark:bg-muted-dark/60"></div>
            <div className="w-[100px] h-[46px] rounded-xl bg-muted/60 dark:bg-muted-dark/60 dark:bg-muted dark:bg-muted-dark/60"></div>
          </div>
        </div>
