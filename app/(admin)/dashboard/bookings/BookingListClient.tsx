  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-foreground/20 bg-background focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
          />
        </div>
        <div className="flex gap-4">
          <div className="relative">
            ...
            <select
              ...
              className="pl-10 pr-8 py-2.5 rounded-xl border border-foreground/20 bg-background focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all appearance-none"
            >
      ...
      {isSearching ? (
        ...
        <div className="p-8 text-center bg-background rounded-2xl border border-foreground/10">
          <p className="text-muted-foreground">Tidak ada data booking yang ditemukan.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {bookings.map((booking, index) => {
            ...
            return (
              ...
              >
                <div
                  className="bg-background border border-foreground/10 p-5 rounded-2xl shadow-sm hover:shadow-md transition-shadow h-full flex flex-col"
                >
      ...
      {!hasMore && bookings.length > 0 && !isSearching && (
        <div className="text-center py-6 text-sm text-muted-foreground pb-24 md:pb-6">
